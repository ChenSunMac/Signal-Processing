...
[Filename,PathName]= uigetfile('*.bin;*.mat','MultiSelect', 'on');
%% One file 4 reads
tic
...
% spmd
    ...
    for fileID = 1:length(Filename)
        ...
        filename = cell2mat(Filename(fileID));
        ...
        for iRead = 1:iReadN
            skipByte = 32096*12*round_per_read * (iRead-1);
        ...
        thickPoints = zeros(96,round_per_read,fileID)+timeFlight;
        coatPoints = zeros(96,round_per_read,fileID)+coatingFlight;
